            ...
            <SectionFour>
                <div className='calendar__header'>
                    <div className='arrow__left'>
                        <Link to={RoutingPath.januaryView}>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><h3>2</h3></td>
                        <td><h3>3</h3></td>
                        <td className='booked'><h3>4</h3></td>
                        <td className='booked'><h3>5</h3></td>
                        <td className='booked'><h3>6</h3></td>
                    </tr>
                    <tr>
                        <td><h3>7</h3></td>
                        <td><h3>8</h3></td>
...
const FebruaryWrapper = styled.section`
  margin: 1px 20px;
