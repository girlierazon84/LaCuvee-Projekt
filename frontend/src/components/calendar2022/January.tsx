            ...
            <SectionFour>
                <div className='calendar__header'>
                    ...
                    <div className='arrow__right'>
                        <Link to={RoutingPath.februaryView}>
                ...
                <table>
                    ...
                    <tr>
                        <td><h3 className='grey__area'>27</h3></td>
                        <td><h3 className='grey__area'>28</h3></td>
                        <td><h3 className='grey__area'>29</h3></td>
                    ...
                    <tr>
                        ...
                        <td><h3 className='grey__area'>4</h3></td>
                        <td><h3 className='grey__area'>5</h3></td>
                        <td><h3 className='grey__area'>6</h3></td>
                    </tr>
                </table>
            </SectionFour>
        </JanuaryWrapper>
...
const JanuaryWrapper = styled.section`
  margin: 1px 20px;
